...
describe('testing options', () => {
  it('parses if fileIdentifier is included in filename', () => {
    const htmlInput = `<Flexbox cs={{ gap: '10px', backgroundColor: 'aqua' }}></Flexbox>`;
    const htmlOutput = `<Flexbox style="gap: 10px; background-color: aqua;"></Flexbox>`;
    const input = script + htmlInput + style;
    const output = script + htmlOutput + style;

    const result = thread(input, 'Test.thread.svelte', { ...options, fileIdentifier: 'thread' });
    expect(result).toEqual(output);
  })
  it('skips parsing if fileIdentifier is not included in filename', () => {
    const htmlInput = `<Flexbox cs={{ gap: '10px', backgroundColor: 'aqua' }}></Flexbox>`;
    const htmlOutput = `<Flexbox cs={{ gap: '10px', backgroundColor: 'aqua' }}></Flexbox>`;
    const input = script + htmlInput + style;
    const output = script + htmlOutput + style;

    const result = thread(input, 'Test.svelte', { ...options, fileIdentifier: 'skip' });
    expect(result).toEqual(output);
  })
  ...
  it('tests elementNames with elements not in array', () => {
    const htmlInput = `<Fakebox cs={{ gap: '10px', backgroundColor: 'aqua' }}></Fakebox>`;
    const htmlOutput = `<Fakebox cs={{ gap: '10px', backgroundColor: 'aqua' }}></Fakebox>`;
    const input = script + htmlInput + style;
    const output = script + htmlOutput + style;
  ...
  it('tests with different identifier', () => {
    const htmlInput = `<Fakebox test={{ gap: '10px', backgroundColor: 'aqua' }}></Fakebox>`;
    const htmlOutput = `<Fakebox test={{ gap: '10px', backgroundColor: 'aqua' }}></Fakebox>`;
    const input = script + htmlInput + style;
    const output = script + htmlOutput + style;

    const result = thread(input, 'Test.svelte', { ...options, attributeName: 'test' });
    expect(result).toEqual(output);
  })
})
...
describe('parsing attributes', () => {
  ...
  it('converts nested components', () => {
    const htmlInput = `<Flexbox cs={{ gap: '10px' }}><Flexbox cs={{backgroundColor: 'aqua'}}></Flexbox></Flexbox>`;
    const htmlOutput = `<Flexbox style="gap: 10px;"><Flexbox style="background-color: aqua;"></Flexbox></Flexbox>`;
    const input = script + htmlInput + style;
    const output = script + htmlOutput + style;
  ...
  it('converts ternary attribute without equals', () => {
    const htmlInput = `<Flexbox cs={{ gap: isGap ? '10px' : '20px' }}></Flexbox>`;
    const htmlOutput = `<Flexbox style="gap: {isGap ? '10px' : '20px'};"></Flexbox>`;
    const input = script + htmlInput + style;
    const output = script + htmlOutput + style;
  ...
  it('converts ternary attribute with equals', () => {
    const htmlInput = `<Flexbox cs={{ gap: isGap === 'yes' ? '10px' : '20px' }}></Flexbox>`;
    const htmlOutput = `<Flexbox style="gap: {isGap === 'yes' ? '10px' : '20px'};"></Flexbox>`;
    const input = script + htmlInput + style;
    const output = script + htmlOutput + style;
...
describe('camelToKebabCase', () => {
  ...
  it('converts camel case with multiple words to kebab case', () => {
    expect(camelToKebabCase('borderTopLeftRadius')).toEqual('border-top-left-radius');
  })
